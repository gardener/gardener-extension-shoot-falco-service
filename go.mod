...
require (
	...
	github.com/prometheus-operator/prometheus-operator/pkg/apis/monitoring v0.80.0 // indirect
	...
	sigs.k8s.io/controller-runtime/tools/setup-envtest v0.0.0-20250203100659-bbc9711d9b2d // indirect
