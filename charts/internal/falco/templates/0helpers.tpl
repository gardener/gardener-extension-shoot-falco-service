...
{{- if not .Values.falco.http_output.url -}}
    ...
    {{- if .Values.falcosidekick.fullfqdn -}}
       {{- printf "http://falcosidekick.%s.svc.cluster.local:%s" .Release.Namespace $listenPort -}}
    {{- else -}}
        {{- printf "http://falcosidekick:%s" $listenPort -}}
    {{- end -}}
{{- else -}}
...
*/}}
{{- define "cluster.name" -}}
{{- .Values.gardener.garden.identity -}}
{{- end -}}
...
{{- if .Values.falcosidekick.fullnameOverride -}}
{{- .Values.falcosidekick.fullnameOverride | trunc 63 | trimSuffix "-" -}}
{{- else -}}
{{- $name := default .Chart.Name .Values.falcosidekick.nameOverride -}}
{{- if contains $name .Release.Name -}}
{{- .Release.Name | trunc 63 | trimSuffix "-" -}}
{{- else -}}
{{- printf "%s-%s" .Release.Name $name | trunc 63 | trimSuffix "-" -}}
...
{{- default .Chart.Name .Values.falcosidekick.nameOverride | trunc 63 | trimSuffix "-" -}}
{{- end -}}
