...
//go:generate crd-ref-docs --source-path=. --config=../../../../hack/api-reference/service-config.yaml --renderer=markdown --templates-dir=$GARDENER_HACK_DIR/api-reference/template --log-level=ERROR --output-path=../../../../hack/api-reference/service.md
