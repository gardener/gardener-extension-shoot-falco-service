...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*FalcoVPA)(nil), (*service.FalcoVPA)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_FalcoVPA_To_service_FalcoVPA(a.(*FalcoVPA), b.(*service.FalcoVPA), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*service.FalcoVPA)(nil), (*FalcoVPA)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_service_FalcoVPA_To_v1alpha1_FalcoVPA(a.(*service.FalcoVPA), b.(*FalcoVPA), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_FalcoConfig_To_service_FalcoConfig(in *FalcoConfig, out *service.FalcoConfig, s conversion.Scope) error {
	...
	out.VPA = (*service.FalcoVPA)(unsafe.Pointer(in.VPA))
	return nil
}
...
func autoConvert_service_FalcoConfig_To_v1alpha1_FalcoConfig(in *service.FalcoConfig, out *FalcoConfig, s conversion.Scope) error {
	...
	out.VPA = (*FalcoVPA)(unsafe.Pointer(in.VPA))
	return nil
}
...
func autoConvert_v1alpha1_FalcoVPA_To_service_FalcoVPA(in *FalcoVPA, out *service.FalcoVPA, s conversion.Scope) error {
	out.MinAllowed = (*service.ResourceValues)(unsafe.Pointer(in.MinAllowed))
	out.MaxAllowed = (*service.ResourceValues)(unsafe.Pointer(in.MaxAllowed))
	return nil
}

// Convert_v1alpha1_FalcoVPA_To_service_FalcoVPA is an autogenerated conversion function.
func Convert_v1alpha1_FalcoVPA_To_service_FalcoVPA(in *FalcoVPA, out *service.FalcoVPA, s conversion.Scope) error {
	return autoConvert_v1alpha1_FalcoVPA_To_service_FalcoVPA(in, out, s)
}

func autoConvert_service_FalcoVPA_To_v1alpha1_FalcoVPA(in *service.FalcoVPA, out *FalcoVPA, s conversion.Scope) error {
	out.MinAllowed = (*ResourceValues)(unsafe.Pointer(in.MinAllowed))
	out.MaxAllowed = (*ResourceValues)(unsafe.Pointer(in.MaxAllowed))
	return nil
}

// Convert_service_FalcoVPA_To_v1alpha1_FalcoVPA is an autogenerated conversion function.
func Convert_service_FalcoVPA_To_v1alpha1_FalcoVPA(in *service.FalcoVPA, out *FalcoVPA, s conversion.Scope) error {
	return autoConvert_service_FalcoVPA_To_v1alpha1_FalcoVPA(in, out, s)
}
