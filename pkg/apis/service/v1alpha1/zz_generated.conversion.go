...
func RegisterConversions(s *runtime.Scheme) error {
	if err := s.AddGeneratedConversionFunc((*Events)(nil), (*service.Events)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_Events_To_service_Events(a.(*Events), b.(*service.Events), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*service.Events)(nil), (*Events)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_service_Events_To_v1alpha1_Events(a.(*service.Events), b.(*Events), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_Events_To_service_Events(in *Events, out *service.Events, s conversion.Scope) error {
	out.Destinations = *(*[]string)(unsafe.Pointer(&in.Destinations))
	out.CustomConfig = (*string)(unsafe.Pointer(in.CustomConfig))
	return nil
}

// Convert_v1alpha1_Events_To_service_Events is an autogenerated conversion function.
func Convert_v1alpha1_Events_To_service_Events(in *Events, out *service.Events, s conversion.Scope) error {
	return autoConvert_v1alpha1_Events_To_service_Events(in, out, s)
}

func autoConvert_service_Events_To_v1alpha1_Events(in *service.Events, out *Events, s conversion.Scope) error {
	out.Destinations = *(*[]string)(unsafe.Pointer(&in.Destinations))
	out.CustomConfig = (*string)(unsafe.Pointer(in.CustomConfig))
	return nil
}

// Convert_service_Events_To_v1alpha1_Events is an autogenerated conversion function.
func Convert_service_Events_To_v1alpha1_Events(in *service.Events, out *Events, s conversion.Scope) error {
	return autoConvert_service_Events_To_v1alpha1_Events(in, out, s)
}
...
func autoConvert_v1alpha1_FalcoServiceConfig_To_service_FalcoServiceConfig(in *FalcoServiceConfig, out *service.FalcoServiceConfig, s conversion.Scope) error {
	...
	out.Events = (*service.Events)(unsafe.Pointer(in.Events))
	return nil
}
...
func autoConvert_service_FalcoServiceConfig_To_v1alpha1_FalcoServiceConfig(in *service.FalcoServiceConfig, out *FalcoServiceConfig, s conversion.Scope) error {
	...
	out.StandardRules = (*[]string)(unsafe.Pointer(in.StandardRules))
	out.CustomRules = (*[]string)(unsafe.Pointer(in.CustomRules))
	out.Events = (*Events)(unsafe.Pointer(in.Events))
	return nil
}
