...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*Destinations)(nil), (*service.Destinations)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_Destinations_To_service_Destinations(a.(*Destinations), b.(*service.Destinations), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*service.Destinations)(nil), (*Destinations)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_service_Destinations_To_v1alpha1_Destinations(a.(*service.Destinations), b.(*Destinations), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_CustomRule_To_service_CustomRule(in *CustomRule, out *service.CustomRule, s conversion.Scope) error {
	out.ResourceRef = (*string)(unsafe.Pointer(in.ResourceRef))
	return nil
}
...
func autoConvert_v1alpha1_Destinations_To_service_Destinations(in *Destinations, out *service.Destinations, s conversion.Scope) error {
	out.Destination = (*[]service.Destination)(unsafe.Pointer(in.Destination))
	return nil
}

// Convert_v1alpha1_Destinations_To_service_Destinations is an autogenerated conversion function.
func Convert_v1alpha1_Destinations_To_service_Destinations(in *Destinations, out *service.Destinations, s conversion.Scope) error {
	return autoConvert_v1alpha1_Destinations_To_service_Destinations(in, out, s)
}

func autoConvert_service_Destinations_To_v1alpha1_Destinations(in *service.Destinations, out *Destinations, s conversion.Scope) error {
	out.Destination = (*[]Destination)(unsafe.Pointer(in.Destination))
	return nil
}

// Convert_service_Destinations_To_v1alpha1_Destinations is an autogenerated conversion function.
func Convert_service_Destinations_To_v1alpha1_Destinations(in *service.Destinations, out *Destinations, s conversion.Scope) error {
	return autoConvert_service_Destinations_To_v1alpha1_Destinations(in, out, s)
}
...
func autoConvert_v1alpha1_FalcoServiceConfig_To_service_FalcoServiceConfig(in *FalcoServiceConfig, out *service.FalcoServiceConfig, s conversion.Scope) error {
	...
	if in.Rules != nil {
		...
		*out = new(service.Rules)
		if err := Convert_v1alpha1_Rules_To_service_Rules(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.Rules = nil
	}
	out.Destinations = (*service.Destinations)(unsafe.Pointer(in.Destinations))
	return nil
}
...
func autoConvert_service_FalcoServiceConfig_To_v1alpha1_FalcoServiceConfig(in *service.FalcoServiceConfig, out *FalcoServiceConfig, s conversion.Scope) error {
	...
	if in.Rules != nil {
		in, out := &in.Rules, &out.Rules
		*out = new(Rules)
		if err := Convert_service_Rules_To_v1alpha1_Rules(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.Rules = nil
	}
	out.Destinations = (*Destinations)(unsafe.Pointer(in.Destinations))
	return nil
}
...
func autoConvert_v1alpha1_Rules_To_service_Rules(in *Rules, out *service.Rules, s conversion.Scope) error {
	...
	if in.CustomRules != nil {
		...
		*out = new([]service.CustomRule)
		// FIXME: Provide conversion function to convert []string to []service.CustomRule
...
func autoConvert_service_Rules_To_v1alpha1_Rules(in *service.Rules, out *Rules, s conversion.Scope) error {
	...
	if in.CustomRules != nil {
		in, out := &in.CustomRules, &out.CustomRules
		*out = new([]string)
		// FIXME: Provide conversion function to convert []service.CustomRule to []string
		compileErrorOnMissingConversion()
	} else {
		out.CustomRules = nil
	}
