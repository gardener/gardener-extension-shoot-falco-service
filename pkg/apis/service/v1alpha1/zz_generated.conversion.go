...
func RegisterConversions(s *runtime.Scheme) error {
	if err := s.AddGeneratedConversionFunc((*ConfigMap)(nil), (*service.ConfigMap)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_ConfigMap_To_service_ConfigMap(a.(*ConfigMap), b.(*service.ConfigMap), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*service.ConfigMap)(nil), (*ConfigMap)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_service_ConfigMap_To_v1alpha1_ConfigMap(a.(*service.ConfigMap), b.(*ConfigMap), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_ConfigMap_To_service_ConfigMap(in *ConfigMap, out *service.ConfigMap, s conversion.Scope) error {
	out.Name = in.Name
	out.Namespace = in.Namespace
	return nil
}

// Convert_v1alpha1_ConfigMap_To_service_ConfigMap is an autogenerated conversion function.
func Convert_v1alpha1_ConfigMap_To_service_ConfigMap(in *ConfigMap, out *service.ConfigMap, s conversion.Scope) error {
	return autoConvert_v1alpha1_ConfigMap_To_service_ConfigMap(in, out, s)
}

func autoConvert_service_ConfigMap_To_v1alpha1_ConfigMap(in *service.ConfigMap, out *ConfigMap, s conversion.Scope) error {
	out.Name = in.Name
	out.Namespace = in.Namespace
	return nil
}

// Convert_service_ConfigMap_To_v1alpha1_ConfigMap is an autogenerated conversion function.
func Convert_service_ConfigMap_To_v1alpha1_ConfigMap(in *service.ConfigMap, out *ConfigMap, s conversion.Scope) error {
	return autoConvert_service_ConfigMap_To_v1alpha1_ConfigMap(in, out, s)
}
